...
L["Give campaign, legendary, dungeon and raid quests their own card color so you can tell them apart at a glance. Anything else uses the plain background color above."] = "Задаёт заданиям кампании, легендарным, подземелий и рейдов собственный цвет карточки, чтобы различать их с первого взгляда. Всё остальное использует обычный цвет фона выше."
L["Card color for campaign quests. Needs Tint cards by quest type switched on."] = "Цвет карточки для заданий кампании. Требует включённого параметра «Окрашивать карточки по типу задания»."
L["Legendary"] = "Легендарное"
L["Card color for legendary quests. Needs Tint cards by quest type switched on."] = "Цвет карточки для легендарных заданий. Требует включённого параметра «Окрашивать карточки по типу задания»."
L["Dungeon"] = "Подземелье"
L["Card color for dungeon quests. Needs Tint cards by quest type switched on."] = "Цвет карточки для заданий подземелий. Требует включённого параметра «Окрашивать карточки по типу задания»."
L["Raid"] = "Рейд"
L["Card color for raid quests. Needs Tint cards by quest type switched on."] = "Цвет карточки для рейдовых заданий. Требует включённого параметра «Окрашивать карточки по типу задания»."
