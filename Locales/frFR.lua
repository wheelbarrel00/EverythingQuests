...
L["Give campaign, legendary, dungeon and raid quests their own card color so you can tell them apart at a glance. Anything else uses the plain background color above."] = "Donne aux quêtes de campagne, légendaires, de donjon et de raid leur propre couleur de carte afin de les distinguer d'un coup d'œil. Tout le reste utilise la couleur d'arrière-plan simple ci-dessus."
L["Card color for campaign quests. Needs Tint cards by quest type switched on."] = "Couleur de carte des quêtes de campagne. Nécessite que Teinter les cartes selon le type de quête soit activé."
L["Legendary"] = "Légendaire"
L["Card color for legendary quests. Needs Tint cards by quest type switched on."] = "Couleur de carte des quêtes légendaires. Nécessite que Teinter les cartes selon le type de quête soit activé."
L["Dungeon"] = "Donjon"
L["Card color for dungeon quests. Needs Tint cards by quest type switched on."] = "Couleur de carte des quêtes de donjon. Nécessite que Teinter les cartes selon le type de quête soit activé."
L["Raid"] = "Raid"
L["Card color for raid quests. Needs Tint cards by quest type switched on."] = "Couleur de carte des quêtes de raid. Nécessite que Teinter les cartes selon le type de quête soit activé."
