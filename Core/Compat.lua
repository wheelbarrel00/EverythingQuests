...
-- KIND picks the id space because creature and object ids overlap (261 is both Guard Thomas and
-- Damaged Crate). It is normalized first, because an object entrance arrives as kind 6.
